...
function italforni_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  italforni_preprocess_html($variables, $hook);
  italforni_preprocess_page($variables, $hook);
}
// */
 ...
 */
function italforni_preprocess_html(&$variables, $hook) {  
  $viewport = array(
    '#tag' => 'meta',
    '#attributes' => array(
      'name' => 'viewport',
 ...
 */
function italforni_preprocess_page(&$variables, $hook) {
...
function italforni_preprocess_node(&$variables, $hook) {
  ...
  // italforni_preprocess_node_page() or italforni_preprocess_node_story().
...
function italforni_preprocess_node_home_page(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function italforni_preprocess_comment(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function italforni_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function italforni_preprocess_block(&$variables, $hook) {
 ...
 * Theme views
 */
function italforni_preprocess_views_view(&$variables) {
 ...
 * Theme views field
 */
function italforni_preprocess_views_view_fields(&$variables) {
  if (isset($variables['view']->name)) {
    $function = __FUNCTION__ . '__' . $variables['view']->name . '__' . $variables['view']->current_display;
		// dsm($function);
    if (function_exists($function)) {
...
function italforni_preprocess_views_view_fields__media__page(&$variables) {
 ...
 */
function italforni_youtube_thumbnail($variables) {
